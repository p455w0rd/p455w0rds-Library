...
/**
 * This interface defines the contract for some object that exposes
 * transmutation knowledge through the Capability system. Acquire an instance of
 * this using
 * {@link net.minecraft.entity.Entity#getCapability(Capability, EnumFacing)}.
 */
public interface IKnowledgeProvider extends INBTSerializable<NBTTagCompound> {

	/**
	 * @return Whether the player has the "tome" flag set, meaning all knowledge
	 *         checks automatically return true
	 */
	boolean hasFullKnowledge();

	/**
	 * @param fullKnowledge
	 *            Whether the player has the "tome" flag set, meaning all
	 *            knowledge checks automatically return true
	 */
	...
	/**
	 * @param stack
	 *            The stack to remove from knowledge
	 * @return Whether the operation was successful
	 */
	...
	/**
	 * @param emc
	 *            The emc to set in this player's transmutation tablet network
	 */
