...
/**
 * This interfaces specifies items that perform a specific function every tick
 * when inside an Alchemical Bag, on a player
 *
 * @author williewillus
 */
public interface IAlchBagItem {
	/**
	 * Called on both client and server every time the alchemical bag ticks this
	 * item
	 *
	 * @param inv
