...
/**
 * This interface specifies items that switch between modes when the mode switch
 * keybind is activated (default G)
 */
public interface IModeChanger {
	 ...
	 * 
	 * @param player
	 *            The player pressing the change mode key
	 * @param stack
	 *            The stack whose mode we are changing
	 * @param hand
