 ...
 *
 */
public class CustomModelState implements IModelState {
	...
	public CustomModelState(ImmutableMap<TransformType, TRSRTransformation> map) {
		this(map, Optional.<TRSRTransformation>absent());
	}

	public CustomModelState(ImmutableMap<TransformType, TRSRTransformation> map, Optional<TRSRTransformation> defaultTransform) {
		this.map = map;
