...
public class RecipeUtils {
	...
	private static String MODID = LibGlobals.MODID;
	private static String MODNAME = LibGlobals.NAME;
	/*
	 ...
	 */
	@Deprecated
	public static IRecipe addOldShaped(ItemStack output, Object... input) {
