...
public class TransformUtils {
	...
	public static final CustomModelState DEFAULT_BLOCK;
	public static final CustomModelState DEFAULT_ITEM;
	public static final CustomModelState DEFAULT_TOOL;
	public static final CustomModelState DEFAULT_BOW;
	public static final CustomModelState DEFAULT_HANDHELD_ROD;
	...
	static {
		...
		DEFAULT_BLOCK = new CustomModelState(defaultBlockBuilder.build());
		...
		DEFAULT_ITEM = new CustomModelState(defaultItemBuilder.build());
		...
		DEFAULT_TOOL = new CustomModelState(defaultToolBuilder.build());
		...
		DEFAULT_BOW = new CustomModelState(defaultBowBuilder.build());
		...
		DEFAULT_HANDHELD_ROD = new CustomModelState(defaultRodBuilder.build());
	}
		...
		if (json.has("transform")) {
			...
			if (transformElement.isJsonPrimitive() && transformElement.getAsJsonPrimitive().isString()) {
				...
				if (transforms.isEmpty()) {
					...
					state = new CustomModelState(Maps.immutableEnumMap(transforms), Optional.of(base));
				}
